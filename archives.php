 ...
 * 
 * If you wish to use Prism's Archives page template, please set 
 ...
 */
	...
	_deprecated_file( sprintf( __( 'The template %s', 'prism' ) . ':', basename(__FILE__) ), '1.0', 'template-page-archives.php' );
